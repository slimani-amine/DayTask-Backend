...
let AuthService = class AuthService {
    ...
    async update(userJwtPayload, userDto) {
        console.log(...oo_oo(`284973047_403_4_403_55_4`, "🚀 ~ AuthService ~ userDto:", userDto));
        if (userDto.password) {
            ...
            console.log(...oo_oo(`284973047_420_6_420_65_4`, "🚀 ~ AuthService ~ currentUser:", currentUser));
            if (!currentUser) {
                throw new common_1.HttpException({
                    status: common_1.HttpStatus.UNPROCESSABLE_ENTITY,
                    errors: {
        ...
        console.log(...oo_oo(`284973047_470_4_470_46_4`, "🚀 ~ AuthService ~ success:"));
        const updated = await this.usersService.update(userJwtPayload.id, userDto);
        console.log(...oo_oo(`284973047_472_4_472_55_4`, "🚀 ~ AuthService ~ updated:", updated));
        return updated;
    }
