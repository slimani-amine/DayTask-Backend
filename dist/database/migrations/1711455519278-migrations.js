...
exports.Migrations1711455519278 = void 0;
class Migrations1711455519278 {
    constructor() {
        this.name = 'Migrations1711455519278';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_3797a20ef5553ae87af126bc2fe"`);
        await queryRunner.query(`CREATE TYPE "public"."message_type_enum" AS ENUM('text', 'image', 'file', 'video', 'audio')`);
        await queryRunner.query(`CREATE TABLE "message" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" SERIAL NOT NULL, "content" text NOT NULL, "type" "public"."message_type_enum" NOT NULL, "seen" boolean NOT NULL DEFAULT false, "senderId" integer, "chatId" integer, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD CONSTRAINT "FK_619bc7b78eba833d2044153bacc" FOREIGN KEY ("chatId") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
...
exports.Migrations1711455519278 = Migrations1711455519278;
//# sourceMappingURL=1711455519278-migrations.js.map