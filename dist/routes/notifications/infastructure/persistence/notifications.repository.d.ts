...
export declare abstract class NotificationsRepository extends GeneralRepositoryType<Notification, FilterNotificationsDto, SortNotificationsDto, Notification['id']> {
    abstract findManyWithPagination({ filterOptions, sortOptions, paginationOptions, userId, }: {
