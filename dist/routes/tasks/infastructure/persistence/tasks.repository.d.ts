import { FilterTaskDto, SortTaskDto } from 'src/routes/tasks/dto/query-task.dto';
...
export declare abstract class TaskRepository {
    abstract create(data: Omit<Task, 'id' | 'createdAt' | 'deletedAt' | 'updatedAt'>): Promise<Task>;
    ...
    abstract update(id: Task['id'], payload: DeepPartial<Task>): Promise<Task | null>;
